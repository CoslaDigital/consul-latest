module Budgets
  module Ballot
    class LinesController < ApplicationController
      include GuestUsers
      puts "About to authenticate"
#      before_action :authenticate_user! || guest_user?
      puts "About to load budget"
      ...
      puts "About to authorize resource  budget"

      authorize_resource :budget
      authorize_resource :ballot
      puts " authorized resource ballot"
      load_and_authorize_resource :line, through: :ballot,
                                         find_by: :investment_id,
                                         class: "Budget::Ballot::Line"
      puts " authorized resource line #{:line}"

      def create
        puts "Here in create line"
        load_investment
        load_heading
