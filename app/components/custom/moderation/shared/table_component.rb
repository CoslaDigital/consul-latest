class Moderation::Shared::TableComponent < ApplicationComponent; end

load Rails.root.join("app", "components", "moderation", "shared", "table_component.rb")

class Moderation::Shared::TableComponent
  attr_reader :records
