class Budgets::Ballot::InvestmentForSidebarComponent < Budgets::Ballot::InvestmentComponent; end

load Rails.root.join("app","components","budgets","ballot","investment_for_sidebar_component.rb")
