...
class MachineLearning
  ...
  AVAILABLE_SCRIPTS = {
    ...
    "poll_summary_answers" => { method: :generate_poll_summary_answers, kind: "comments_summary" },
    "budget_overall_summary" => { method: :generate_budget_overall_summary, kind: "comments_summary" }
  }.freeze
