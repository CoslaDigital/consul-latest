module Sensemaker
  class Job < ApplicationRecord
    ...
    def self.for_process(process)
      ...
      published
        .where(analysable_type: "Legislation::Process", analysable_id: process.id) # ← ADD THIS
        .or(published.where(analysable_type: "Legislation::Proposal", analysable_id: proposals_subquery))
